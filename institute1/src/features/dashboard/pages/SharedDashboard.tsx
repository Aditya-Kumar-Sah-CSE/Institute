...
const PollAlerts = dynamic(() => import('@/features/dashboard/components/PollAlerts'));
const DashboardPolls = dynamic(() => import('@/features/dashboard/components/DashboardPolls'), { loading: () => <div className="skeleton-dash" style={{ height: '200px', borderRadius: '12px' }}></div> });
const ContinueLearning = dynamic(() => import('@/features/dashboard/components/ContinueLearning'), { loading: () => <div className="skeleton-dash" style={{ height: '250px', borderRadius: '12px' }}></div> });
const DashboardAlerts = dynamic(() => import('@/features/dashboard/components/DashboardAlerts'));
...
export default async function SharedDashboard(props: { context: RequestContext; 
  ...
  const noticesPromise = getNotices(2, tenant?.id);

...
export function parseVoiceIntent(rawTranscript: string): ParsedVoiceCommand {
  ...
  // Default fallback match for general voice insertion
  return {
    intent: 'insert_math',
    type: 'generic',

...
export default function CreatePollWidget({ courseId, hideHeading = false }: CreatePollWidgetProps) {
  ...
  return (
    <>
      ...
      {isExpanded && (
        <div style={{ marginBottom: 'var(--space-xl)', background: 'rgba(10, 132, 255, 0.03)', border: '1px solid rgba(10, 132, 255, 0.15)', padding: 'var(--space-lg)', borderRadius: 'var(--radius-lg)', width: '100%', maxWidth: 'min(100%, 600px)', boxSizing: 'border-box' }}>

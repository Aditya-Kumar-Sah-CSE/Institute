...
export default function CreateAlertSection({ courseId }: CreateAlertSectionProps) {
  ...
  return (
    <div className="desktop-50-card" style={{ marginBottom: 'var(--space-xl)', background: 'rgba(255, 59, 48, 0.05)', border: '1px solid rgba(255, 59, 48, 0.2)', padding: 'var(--space-lg)', borderRadius: 'var(--radius-lg)', boxSizing: 'border-box' }}>

...
async function main() {
  ...
  try {
    console.log('Updating student_external_accounts_platform_check constraint to include GEEKSFORGEEKS...');
    ...
    await sql`
      ALTER TABLE public.student_external_accounts
        ...
        CHECK (platform IN ('CODEFORCES', 'LEETCODE', 'CODECHEF', 'GEEKSFORGEEKS'));
    `;

    console.log('SUCCESS: platform check constraint now allows CODEFORCES, LEETCODE, CODECHEF, GEEKSFORGEEKS');
  } catch (err) {

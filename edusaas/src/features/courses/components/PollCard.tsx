...
const formatDistanceToNow = (date: any, config?: any) => 'recently';
import { User } from 'lucide-react';
// Mocking external data actions
const submitPollVote = async (pollId: string, options: string[], courseId: string) => ({ success: true, error: null });
const deleteCoursePoll = async (pollId: string, courseId: string) => ({ success: true, error: null });
